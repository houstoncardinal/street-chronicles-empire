...
export const initialGameState: GameState = {
  ...
  missions: [
    ...
    { id: 'm-north-1',  title: 'GOVERNMENT BLOCK',  description: 'Make your move on Government St. The north side needs to know who runs this city.', district: 'the-block', type: 'errand', difficulty: 2, rewards: { money: 400,  fans: 30,  streetRep: 8,  industryFame: 0,  crewLoyalty: 5  }, requiredLevel: 2, completed: false, locked: true },
    { id: 'm-downtown', title: 'TOWER HUSTLE',       description: 'Control the downtown corridor. Move product through the office district before the suits call the cops.', district: 'downtown', type: 'rival', difficulty: 3, rewards: { money: 800,  fans: 60,  streetRep: 15, industryFame: 5,  crewLoyalty: 8  }, requiredLevel: 3, completed: false, locked: true },
    { id: 'm-mall',     title: 'MALL TAKEOVER',      description: 'Own the Cortana Mall block. Establish corners in every wing before rival crews set up shop.', district: 'club-district', type: 'rival', difficulty: 4, rewards: { money: 1500, fans: 200, streetRep: 20, industryFame: 10, crewLoyalty: 12 }, requiredLevel: 4, completed: false, locked: true },
    { id: 'm-west',     title: 'SUBURB SWEEP',       description: 'Expand west into the suburbs. Quiet blocks mean easy money — if you move fast enough.', district: 'the-block', type: 'defend', difficulty: 2, rewards: { money: 500,  fans: 40,  streetRep: 10, industryFame: 0,  crewLoyalty: 6  }, requiredLevel: 2, completed: false, locked: true },
    { id: 'm-ghost',    title: 'GHOST ENCOUNTER',    description: "A mysterious glowing ghost haunts the alley behind the cinema. It's been there for weeks. Nobody knows what it wants.", district: 'the-block', type: 'errand', difficulty: 1, rewards: { money: 666, fans: 66, streetRep: 6, industryFame: 6, crewLoyalty: 6 }, requiredLevel: 1, completed: false, locked: false },
    { id: 'm-console',  title: 'RETRO GAME SESSION', description: "A retro console has appeared outside the Virtual Studio. Someone left it running. There's a high score to beat.", district: 'the-block', type: 'errand', difficulty: 1, rewards: { money: 300, fans: 50, streetRep: 3, industryFame: 8, crewLoyalty: 2 }, requiredLevel: 1, completed: false, locked: false },
  ],
  songs: [
