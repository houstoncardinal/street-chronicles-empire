...
export const initialGameState: GameState = {
  ...
  missions: [
    ...
    { id: 'm4', title: 'RECOVER ARTIFACT', description: 'Find the hidden artifact deep in the mountain caves.', district: 'studio-row', type: 'record', difficulty: 2, rewards: { money: 500, fans: 100, streetRep: 5, industryFame: 15, crewLoyalty: 5 }, requiredLevel: 2, completed: false, locked: true },
    ...
    { id: 'm7', title: 'CABIN SEARCH', description: 'Search the abandoned cabin on Gravedigger Mountain.', district: 'downtown', type: 'errand', difficulty: 3, rewards: { money: 800, fans: 30, streetRep: 8, industryFame: 10, crewLoyalty: 5 }, requiredLevel: 3, completed: false, locked: true },
...
export function loadGameState(): GameState {
  try {
    ...
    if (saved) {
      ...
      // Merge with initial state to add any new fields
